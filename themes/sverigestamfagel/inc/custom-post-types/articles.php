<?php
$labels = array(
    'name'                  => _x( 'Artiklar', 'Post Type General Name', 'sverigestamfagelforening' ),
    'singular_name'         => _x( 'Artikel', 'Post Type Singular Name', 'sverigestamfagelforening' ),
    'menu_name'             => __( 'Artiklar', 'sverigestamfagelforening' ),
    'name_admin_bar'        => __( 'Artiklar', 'sverigestamfagelforening' ),
...
$args = array(
    'label'                 => __( 'Artiklar', 'sverigestamfagelforening' ),
