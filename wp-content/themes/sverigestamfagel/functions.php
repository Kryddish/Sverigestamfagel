	...
	if ($contact_form->title === 'Bli medlem') {
		...
		if (!username_exists($email) && !email_exists($email)) {
			...
			$user_id = wp_insert_user([
				'display_name' 	=> wp_slash($first_name),
			...
			update_field('address', $_POST['your-address'], "user_$user_id");
			update_field('zip_code', $_POST['your-zipcode'], "user_$user_id");
			update_field('postal_address', $_POST['your-postaddress'], "user_$user_id");
		}
	}
}, 10, 3);
